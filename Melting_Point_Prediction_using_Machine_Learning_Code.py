...
class MeltingPointPipeline:
    ...
    def create_pca_features(self):
        ...
        self.log_result(f"Original features: {self.X_train_scaled.shape[1]} → PCA features: {self.X_train_pca.shape[1]}")
    ...
    def baseline_models(self):
        ...
        for track_name, X_tr, X_v in [
            ...
            self.log_result(f"\n{track_name}:")
            self.log_result(f"  MAE: {mae:.4f} ← PRIMARY METRIC")
    ...
    def train_multiple_models(self):
        ...
        for track_name, X_tr, X_v in [
            ...
            for name, model in models.items():
                ...
                self.log_result(f"  ✓ Val MAE: {val_mae:.4f}, R²: {val_r2:.4f}")
    ...
    def select_best_model(self):
        ...
        self.log_result(f"\n🏆 BEST MODEL: {best['Name']} ({best['Track']})")
        self.log_result(f"  Validation MAE: {best['Val_MAE']:.4f} ← PRIMARY METRIC")
        ...
        plt.close()
        self.log_result("\n✓ Saved: 05_top_models_comparison.png")
    ...
    def retrain_and_predict(self):
        ...
        plt.close()
        self.log_result("\n✓ Saved: 06_predictions_analysis.png")
